        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              <a href="/" className="text-2xl font-bold">MICO</a>
              <div className="hidden md:flex items-center space-x-6">
                <a href="#" className="hover:text-green-600 transition">Book a Slot</a>
                <a href="#" className="hover:text-green-600 transition">Find Therapists</a>
                <a href="#" className="hover:text-green-600 transition">About us</a>
                <a href="#" className="hover:text-green-600 transition">Ranting</a>
                <a href="#" className="hover:text-green-600 transition">For Business</a>
                <a href="#" className="hover:text-green-600 transition">Resources</a>
                <a href="#" className="hover:text-green-600 transition">Careers</a>
              </div>
            </div>
